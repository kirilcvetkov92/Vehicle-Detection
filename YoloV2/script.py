...
from keras.layers import (Conv2D, GlobalAveragePooling2D, Input, Reshape,
                          ZeroPadding2D, UpSampling2D, Activation,Add,MaxPooling2D,Lambda)
...
from yad2k.keras_yolo import (space_to_depth_x2,
...
def _main(args):
    ...
    if len(outputs)==0: outputs.append(len(all_layers)-1)
